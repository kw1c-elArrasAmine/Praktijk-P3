...
<div class="imgallign">
    <img class="logo" src="images/factory.jpg" alt="factory">
</div>
...
<!--geschiedenis gedeelte-->
    ...
    <div><img class="alfred" src="images/Alfred_Krupp.jpg" alt="Alfred Krupp">
        <p>Foto van Alfred Krupp</p></div>

    <div><P>Later werd het bedrijf nog beroemder door het 88mm Flak kanon die het Duitsers niet alleen het gebruikte als anti-Lucht, maar ook anti-tank kanon. Krupp is ook verantwoordelijk aan iconische tanks zoals het Panther tank en Panzer II en is het ontwerper van andere iconische tanks zoals Tiger tank, Panzer VI en III.  Krupp is een belangrijke stuk van geschiedenis van Duitsland en dankzij het bedrijf stond het Duitse militaire industrie sterk.</P></div>
</div>
